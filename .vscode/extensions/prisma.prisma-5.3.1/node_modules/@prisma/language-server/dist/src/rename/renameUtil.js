...
function isRelationField(currentLine, lines) {
    const relationNames = (0, util_1.getAllRelationNames)(lines, util_1.relationNamesRegexFilter);
...
function renameModelOrEnumWhereUsedAsType(block, lines, document, position, blockType) {
    ...
    const allRelationNames = (0, util_1.getAllRelationNames)(lines, util_1.relationNamesRegexFilter);

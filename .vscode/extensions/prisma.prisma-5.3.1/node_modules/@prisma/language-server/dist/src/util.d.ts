...
export declare const relationNamesRegexFilter: RegExp;
export declare const relationNamesMongoDBRegexFilter: RegExp;
...
export declare function getAllRelationNames(lines: string[], regexFilter: RegExp): string[];

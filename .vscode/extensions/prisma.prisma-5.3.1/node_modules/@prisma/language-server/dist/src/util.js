...
function getAllRelationNames(lines, regexFilter) {
    const modelNames = [];
...
const getDocumentation = (document, line, comments) => {
    const comment = document.getText({
        ...
        end: { line: line - 1, character: exports.MAX_SAFE_VALUE_i32 },
    });
